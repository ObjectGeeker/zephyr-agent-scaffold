...
@Component
public class SequentialAgentNode extends AbstractAgentAssemblySupport {
    ...
    protected AgentAssemblyRegisterVO doApply(AgentAssemblyCommandVO requestParameter, DefaultAgentAssemblyFactory.DynamicContext dynamicContext) throws Exception {
        log.debug("agent auto assembly sequential agent node start");

        buildMultiAgent(dynamicContext, (currentAgent, subAgents) -> SequentialAgent.builder()
        ...
        log.debug("agent auto assembly sequential agent node end");
