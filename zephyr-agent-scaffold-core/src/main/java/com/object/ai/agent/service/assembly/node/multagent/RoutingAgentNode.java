...
@Component
public class RoutingAgentNode extends AbstractAgentAssemblySupport {
    ...
    protected AgentAssemblyRegisterVO doApply(AgentAssemblyCommandVO requestParameter, DefaultAgentAssemblyFactory.DynamicContext dynamicContext) throws Exception {
        log.debug("agent auto assembly routing agent node start");

        buildMultiAgent(dynamicContext, (currentAgent, subAgents) -> LlmRoutingAgent.builder()
        ...
        log.debug("agent auto assembly routing agent node end");
